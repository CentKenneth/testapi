...
class PatientServices
{
    ...
    public function printScheduleHistory(array $data)
    {
        try {
            ...
            $pdf = PDF::loadView('pdf.reports-history', compact('datas'));
            ...
            $pdf->download('pdf.reports-history');
    ...
    public function printScheduleFaceHistory(array $data)
    {
        try {
            $items = resolve('PatientScheduleFace')->index($data);
    ...
    public function printScheduleInfo(array $data)
    {
        try {
            $items = resolve('PatientSchedule')->index($data)->where('patient_id', $data['pat_id']);
            
            $items = $items->get();

            $datas = TransformerHelper::collection($items, new PatientScheduleTransformer, $data);
            
            $pdf = PDF::loadView('pdf.reports-patient-info', compact('datas'));
            ...
            $pdf->download('pdf.reports-patient-info');
    ...
    public function printScheduleFaceInfo(array $data)
    {
        try {
            $items = resolve('PatientScheduleFace')->index($data)->where('patient_id', $data['pat_id']);
