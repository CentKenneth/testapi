                ...
                <tbody>
                    @foreach ($datas['data'] as $data)
                        <tr class="body-table">
                            ...
                            <td class="body-table" style="width: 20%; padding: 10px;">
                                <span style="font-family: DejaVu Sans; sans-serif;">&#8369;</span>{{ number_format($data['payments'], 2)}}
                            </td>
                        </tr>
                    @endforeach
                    <tr class="body-table">
                        ...
                        <td class="body-table" style="width: 20%; padding: 10px;font-weight: bold;">
