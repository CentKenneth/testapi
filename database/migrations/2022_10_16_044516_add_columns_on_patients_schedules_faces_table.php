...
class AddColumnsOnPatientsSchedulesFacesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('patient_schedule_faces', function (Blueprint $table) {
            $table->string('case_history')->nullable()->after('status');
